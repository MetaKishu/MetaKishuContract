/**
METAKISHU
Meta kishu is a NFT staking platform, and marketplace on the binance smart chain network.
Tokenomics:
5% of each buy/sell goes to existing holders.
5% of each buy/sell goes to buy back $MEKIS tokens.

Website:
https://metakishu.finance/

Telegram:
https://t.me/metakishu_bsc

Twitter:
https://twitter.com/metakishu
...
contract MetaKishu is Context, IERC20, Ownable {
  ...
  address payable public _MEKISWalletAddress;
  ...
  constructor(
    address payable MEKISWalletAddress,
    address payable marketingWalletAddress
  ) {
    _MEKISWalletAddress = MEKISWalletAddress;
  ...
  function sendETHToTeam(uint256 amount) private {
    _MEKISWalletAddress.call{ value: amount.div(2) }('');
  ...
  function _setMEKISWallet(address payable MEKISWalletAddress) external onlyOwner {
    _MEKISWalletAddress = MEKISWalletAddress;
  }
